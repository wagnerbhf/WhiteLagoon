...
namespace WhiteLagoon.Application.Services.Implementation
{
    public class VillaService : IVillaService
    {
        ...
        public void CreateVilla(Villa villa, string webRootPath)
        {
            if (villa.Image != null)
            {
                string fileName = Guid.NewGuid().ToString() + Path.GetExtension(villa.Image.FileName);
                string imagePath = Path.Combine(webRootPath, @"images\VillaImage");
        ...
        public bool DeleteVilla(int id, string webRootPath)
        {
            try
            {
        ...
        public void UpdateVilla(Villa villa, string webRootPath)
        {
            if (villa.Image != null)
            {
                string fileName = Guid.NewGuid().ToString() + Path.GetExtension(villa.Image.FileName);
                ...
                {
                    var oldImagePath = Path.Combine(webRootPath, villa.ImageUrl.TrimStart('\\'));
